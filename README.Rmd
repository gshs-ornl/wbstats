...
Now that each indicator is it's own column, we can implement a great suggestion by [vincentarelbundock](https://github.com/vincentarelbundock) to allow custom names for the indicators 
```{r}
library(wbstats)
